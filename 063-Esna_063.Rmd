...
This is the southern door of Esna,  
...
a bow in [her hand...]  
[...] the 16th of the second month of Peret (Meshir):[^fn-63-3]  
...
[^fn-63-5]: ![](images/63_5.png){width=22%} - A frequent epithet at Esna, which appears to refer to a primeval Kematef serpent (Neith) creating a similar, ophidian demiurge  (Khnum-Tatenen); cf. @klotz-caesar, p. >>. The mother and father serpents are said to be indistinguishable in [Esna 65], 2.  
  
[^fn-63-6]: ![](images/63_6.png){width=25%} - Thanks to acrophony, Tatenen (*TN*) and Neith (*NT*) can be written as palindromes, as in the paralel [Esna 104], 4. Elsewhere this happens with a vulture (*n*) and scarab (*t*) (e.g. [Esna 71],6; cf. @lieven-toricht), so it is less clear what the two scarabs are doing here. They either refer to each divinity, or this is the beginning of a standard epithet such as occurs in [Esna 104, 4]: *ḫpr ḫpr.w, ḫpr ḫprw nb m-ḫt [ḫpr=sn]*.  
