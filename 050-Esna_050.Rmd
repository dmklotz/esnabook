...
- Bibliography: None  
- [Photograph](http://www.temples-egypte.net/sud/esna/devant/montantSud.html){target="_blank"}
...
[...]  
Bastet[^fn-50-3], ^11^ great of heat,  
...
[^fn-50-3]: ![](images/50_2.png){width=22%} - Sauneron's copy includes a heart sign, but a close parallel in *Esna* II, 15, 17 (Menhyt) shows the correct reading: ![](images/50_1.png){width=20%} (suggestion by Daniel Arpagaus). The subsequent epithets are also paralleled in that text.
