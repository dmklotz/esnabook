...
[^fn-75-1]: ![](images/75_1.png){width=30%}. Reading uncertain. The initial epithet seems likely, assuming the first sign writes *pḏ*, "to stretch out (wings)" (*Wb* I, 568, 2). For the location, compare [Esna 58], 1.
