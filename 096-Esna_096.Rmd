...
[^fn-96-1]: ![](images/96_1.png){width=6%}. This verb is used in [Esna II, 110],1; [Esna II, 127],6.
[^fn-96-2]: *Wb* V, 255, 1-2; *DZA* 30.974.690 and following.
[^fn-96-3]: ![](images/96_3.png){width=15%}. Reading uncertain, but assuming the *q* is a rare phonetic spelling of *kȝ* error. For these terms mentioned as a pair, compare [Esna II, 105],4.
[^fn-96-4]: ![](images/96_4.png){width=15%}. The horizontal sign is likely the sky (*p.t*), the vertical sign the potter's wheel.
[^fn-96-5]: ![](images/96_5.png){width=15%}
[^fn-96-6]: ![](images/96_6.png){width=18%}. Note the acrophonic spelling of Shu: *š* < *šnb.t*, *w* < *wỉȝ* (cf. @klotz-baboons, p. 34, n. 8); the divine name Shu is written with an elaborate bark also in [Esna II, 156], 25.
[^fn-96-7]: ![](images/96_7.png){width=10%}
