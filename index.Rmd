...
```
As a first goal, I am working exclusively on the Roman Period inscriptions from *Esna* II (scenes 46-193). So far, **`r n_total`/148 (`r round(100.0*n_total/148.0, 1)`%)** of those scenes are complete and online. I started with the shortest inscriptions, and am now slowly working through the longer hymns, calendars, and "temple monographies."
