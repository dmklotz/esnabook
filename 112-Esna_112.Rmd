...
[^fn-112-1]: ![](images/112_1.png){width=10%}: The reading is not entirely certain, and it is unclear if this is an epithet or a divine name for the ram-headed crocodile. *LGG* VII, 128a, cites only this example, tentatively translating: "Der das Land erleuchtet."

[^fn-112-2]: The element for "Re" is damaged, but Sauneron suggested it might be: ![](images/112_2.png){width=5%}. Thus a graphic allusion to Re emerging from the flood, as described in the present text. 
